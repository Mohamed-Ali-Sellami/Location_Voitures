...
import { getuser, logout, userCurrent } from "./JS/userSlice";
...
import Reservations from "./components/Dashboard/Components/Reservations";
  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        <Route path="/reservations/id:_i" element={<Reservation />} />

        <Route path="/reservationsAdmin" element={<Reservations />} />
