...
const createNotification = () => {
  NotificationManager.success('Succes de Reservation','Profite Avec!', 5000, () => {
    alert('Rod Belak 3liha');
  })};
  ...
  return (
    <div>
      ...
      {carreserver?.map((data) => (
        ...
        <button type="submit" className='confirmerreservation'  onClick={() => dispatch(newreservation({id:data?._id,reservation:addreservation}), createNotification('success'))}  >
          Confirmer
        </button>
