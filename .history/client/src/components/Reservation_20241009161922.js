...
const createNotification = () => {
  NotificationManager.error('Succes de Reservation', 5000, () => {
  ...
  return (
    <div>
      ...
      {carreserver?.map((data) => (
        ...
        <button type="submit" className='confirmerreservation'  onClick={() => dispatch(newreservation({id:data?._id,reservation:addreservation}), {this.createNotification('success')})}  >
          Confirmer
        </button>
