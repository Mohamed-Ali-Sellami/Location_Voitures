        ...
        <h3>Model Réservé:</h3>
          ...
          <div key={data._id}>
            ...
            <input
              type="date"
              value={endDate}
              onChange={(e) => (setEndDate(e.target.value),setaddreservation({...addreservation,endDate:e.target.value}),setaddreservation({...addreservation,totalPrice:totalPrice}))}  // onChange={(e) => setEndDate(e.target.value)}
            />

            <h3>Total Price:</h3>
            <input type="text" value={totalPrice ? `${totalPrice} TND` : '0 TND'} readOnly  onChange={(e)=>}  />
          </div>
