...
price_per_day } TND</td>
                ...
                <td data-label="settings">
                    ...
                    (<>  
                     ...
                     <p>Matricules</p><input type="text" placeholder={data.matriculation} onChange={(e)=>setupcar({name:e.target.value})}/> 
                     <p>Price per day</p><input type="text" placeholder={data.price_per_day} onChange={(e)=>setupcar({name:e.target.value})}/> 
                     <p>Availability</p><input type="text" placeholder={data.availability_status} onChange={(e)=>setupcar({name:e.target.value})}/> 
