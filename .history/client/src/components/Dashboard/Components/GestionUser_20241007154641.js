            ...
            <div className='bodygestionuser'>
                <table>
                    ...
                    <div className='updatecarsettings'>
                     ...
                     <p>email</p><input type="text" placeholder={data.email} onChange={(e)=>setupuser({matriculation:e.target.value})}/> 
                     <p>Telephone Mobile</p><input type="text" placeholder={data.mobile} onChange={(e)=>setupcar({price_per_day:e.target.value})}/> 
                     <p>date_of_obtaining_permit</p><input type="text" placeholder={data.date_of_obtaining_permit} onChange={(e)=>setupcar({availability_status:e.target.value})}/> 
                     </div> 
