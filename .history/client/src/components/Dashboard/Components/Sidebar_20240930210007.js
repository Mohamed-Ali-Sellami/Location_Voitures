...
function Sidebar() {
  return (
    <div className="sidebar">
      <h2> SELLAMI CARS</h2>
      <ul>
      <Link to="/"> <li>  <i class="fa-solid fa-house"></i>  Home </li> </Link>
             ...
             <Link to="/reservations"><li> <i class="fa-solid fa-calendar-days"></i> Resrvations</li> </Link>
        <li> <i class="fa-solid fa-chart-simple"></i>Statistiques</li>
        <li> <i class="fa-solid fa-person-walking-arrow-right"></i>exit</li>
      </ul>
    </div>
  );
}
