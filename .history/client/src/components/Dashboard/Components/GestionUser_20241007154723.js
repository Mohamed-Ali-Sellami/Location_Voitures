            ...
            <div className='bodygestionuser'>
                <table>
                    ...
                    <div className='updatecarsettings'>
                     ...
                     <p>Telephone Mobile</p><input type="text" placeholder={data.mobile} onChange={(e)=>setupcar({mobile:e.target.value})}/> 
                     <p>date_of_obtaining_permit</p><input type="text" placeholder={data.date_of_obtaining_permit} onChange={(e)=>setupcar({date_of_obtaining_permit:e.target.value})}/> 
                     </div> 
