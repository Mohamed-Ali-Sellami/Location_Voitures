            ...
            <div className='bodygestionuser'>
                <table>
                    ...
                    <div className='updatecarsettings'>
                     <p>Models car</p><input type="text" placeholder={data.model} onChange={(e)=>setupuser({name:e.target.value})}/> 
                     <p>Matricules</p><input type="text" placeholder={data.matriculation} onChange={(e)=>setupuser({matriculation:e.target.value})}/> 
